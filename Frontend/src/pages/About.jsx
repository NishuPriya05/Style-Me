    ...
    <div>
      ...
      <div className="my-8 flex flex-col md:flex-row gap-16">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-gray-600">
          <p>
            Style Me was born out of a passion for innovation and a desire to
          ...
          <p>
            Our mission at Style Me is to empower customers with choice,
            convenience, and confidence. We&apos;re dedicated to providing a
            seamless shopping experience that exceeds exceptions, from browsing
